...
class _MyHomePageState extends State<MyHomePage> {
  ...
  Widget build(BuildContext context) {
    ...
    final PreferredSizeWidget appBar = Platform.isIOS ? _buildCupertinoNavigationBar() : _buildMaterialAppBar();
      ...
      child: SingleChildScrollView(
        child: Column(
          ...
          children: <Widget>[
            ...
            if (!isLandscape) ..._buildPotraitContent(mediaQuery, appBar, transactionListWidget),
          ],
        ),
      ),
    );
